            ...
            <div class="container">
                ...
                <div  class="navbar-collapse collapse d-sm-inline-flex ">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light" href="destinos">Destinos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="promo">Promoções</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="dropdown">
                                ...
                                Gerenciar
                                    ...
                                    <div class="dropdown-menu bg-success text-light shadow " aria-labelledby="dropdownMenuButton">
                                        <a class="nav-link text-light" href="cliente/listarcliente">Clientes</a>
                                        <a class="nav-link text-light" href="destino/listardestino">Destinos</a>
                                        <a class="nav-link text-light" href="pacote/listarpacote">Pacotes</a>
                                    </div>
                            </div>
                        </li>
                    </ul>
