...
/**
 * Servlet implementation class ControlerDestinos
 */
@WebServlet("/destinos")
public class ControlerDestinos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControlerDestinos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		despacho = request.getRequestDispatcher("destinos.jsp");
