...
/**
 * Servlet implementation class ControlerPromo
 */
@WebServlet("/promo")
public class ControlerPromo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControlerPromo() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		destinos = dao.ListarPromo();
		request.setAttribute("dest", destinos);
		
		despacho = request.getRequestDispatcher("promo.jsp");
