                    ...
                    <div className="justify-content-end">       
                        ...
                        <div  className="navbar-collapse collapse d-sm-inline-flex">
                            <ul className="navbar-nav flex-grow-1">
                                ...
                                <li class="nav-item">
                                    <Link className="nav-link text-light" to="/destinos">Destinos</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-light" to="/promo">Promoções</Link>
                                </li>
                                <li className="nav-item">
                                ...
                                <li>
                                    <div className="dropdown">
                                        ...
                                        <div className="dropdown-menu bg-success text-light shadow " aria-labelledby="dropdownMenuButton">
                                            ...
                                            <Link className="nav-link text-light" to="/destino">Destino</Link>
