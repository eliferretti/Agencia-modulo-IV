            ...
            <div className="overflow-auto ">
                <table className="table table-sm table-striped " >
                    ...
                    <tbody>    	
                        ...
                        <PacoteTr Id="2" Cliente="Ana Maria"     Destino="Leblon"     DataCompra="88/88/8888" DataViagem="88/88/8888" Preco="R$ 888,88" />
                        <PacoteTr Id="3" Cliente="Maria Silva"   Destino="Ipanema"    DataCompra="77/77/7777" DataViagem="77/77/7777" Preco="R$ 777,77" />
                    </tbody>
                </table>
            </div>
        </div>
