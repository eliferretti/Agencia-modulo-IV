const DestinoAdicionar = () => {
    return(
        <div className="container">
		<h1 className="titulo-paginas border-bottom">Novo destino</h1>
		<div className="row">
		    <div className="col-md-6">
		        <form name="form" action="" method="">  
		            <div className="form-group col-md-6">
		                <label className="control-label">Título</label>
		                <input type="text" name="txtTitulo" className="form-control" />
		            </div>
		            ...
		            <div className="form-group col-md-3">
		                ...
		                <input type="text" name="txtPreco" className="form-control" />
		            </div>
		            <div className="form-group col-md-6">
...
export default DestinoAdicionar;